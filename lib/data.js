  ...
  experience: [
    {
      ...
      period: "January 2026 - March 2026",
      bullets: [
        "Migrated legacy React-based admin panel to Next.js production architecture, improving routing structure and performance",
        "Integrated frontend with existing backend services via REST APIs, ensuring seamless data flow across dashboards and management tools",
        "Refactored components into reusable modular structure using modern React + Next.js patterns",
        "Implemented optimized page rendering using SSR/CSR strategies where appropriate",
        "Improved maintainability by restructuring project folders and aligning with scalable frontend architecture practices",
        "Collaborated with backend team to debug API issues and ensure correct contract handling",
        "Enhanced UI responsiveness and overall developer experience during migration"
      ],
      tech: "Next.js, React, JavaScript, REST APIs, TailwindCSS, Zustand, Axios"
    }
  ],
  projects: [
    {
